const wpccpMessage = "Sorry, Copyrighted Content",
  wpccpPaste = "",
  wpccpUrl =
    "https://www.alamirstation.com/wp-content/plugins/wp-content-copy-protection/";
function disableSelection(e) {
  void 0 !== e.onselectstart
    ? (e.onselectstart = function () {
        return !1;
      })
    : void 0 !== e.style.MozUserSelect
...
function wpccpDisableKeys(e) {
  (["Control", "Alt", "F12"].includes(e.key) ||
    [91, 93, 224].includes(e.keyCode)) &&
    e.preventDefault();
}
...
(window.onload = function () {
  ...
  (document.oncontextmenu = function (e) {
    ...
    return (
      ("A" === n.nodeName && "text" === n.type) ||
      "password" === n.type ||
      (wpccpMessage && alert(wpccpMessage), !1)
    );
  }),
